...
console.log('ok 1/23: doctor 识别根级键位置问题');
"
...
echo "ok 11/23: sessions --show 对话查看"
...
echo "ok 12/23: sessions 导出 Markdown"
...
if (!r || r.status !== 'ok') process.exit(1);
console.log('ok 18/23: doctor 日志体积检查');
"
...
echo "ok 19/23: sessions --stats 用量统计"
...
console.log('ok 20/23: CODEX_HOME 跟随');
"
...
echo "ok 22/23: doctor auth.json 结构校验"
