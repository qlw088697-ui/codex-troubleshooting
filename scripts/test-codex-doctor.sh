...
console.log('ok 1/18: doctor 识别根级键位置问题');
"
...
echo "ok 11/18: sessions --show 对话查看"
...
echo "ok 12/18: sessions 导出 Markdown"
...
if (!r || r.status !== 'ok') process.exit(1);
console.log('ok 18/18: doctor 日志体积检查');
"
